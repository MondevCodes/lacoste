  ...
  public override async run(interaction: ButtonInteraction) {
    ...
    if (!isAuthorized) {
      await interaction.reply({
        content: `Não autorizado. Você precisa ter PELO MENOS o cargo de <@&1173398360623955969> para acessar a função "Acompanhar Gerência".`,
        ephemeral: true,
      });
    ...
    await i
      ...
      .catch(() =>
        this.container.logger.error(
          "[FormAcompanhamento] Couldn't delete reply."
        )
      );
